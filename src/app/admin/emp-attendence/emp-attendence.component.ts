...
@Component({
  selector: 'app-emp-attendence',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './emp-attendence.component.html',
  styleUrls: ['./emp-attendence.component.scss'],
  animations: [
    trigger('modalFade', [
      transition(':enter', [
...
export class EmpAttendenceComponent implements OnInit {
  employeeId: any;
  employee: any = {
    name: 'John Doe',
    empId: 'CF-001',
  ...
  constructor(
    ...
    this.leaveForm = this.fb.group({
      status: ['Full Day', Validators.required],
  ...
  closeLeaveModal() {
    ...
    this.leaveForm.reset({ status: 'Full Day' });
  }
